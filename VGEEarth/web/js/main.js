...
//Tabs on Hover
// jQuery('.sidebar-tabs .nav a.nav-link1').hover(function(e){
// 	e.preventDefault();
...
var flag = false
var tabid=""
jQuery('.sidebar-tabs .nav a.nav-link').click(function (e) {
	tabContentSelector = jQuery(this).attr('href');
	//alert( jQuery(this).attr('id'))
	if(tabid==jQuery(this).attr('id'))
	{
	 jQuery('.sidebar-tabs').hasClass("sidebar-tabsmin")? jQuery('.sidebar-tabs').removeClass('sidebar-tabsmin'):jQuery('.sidebar-tabs').addClass('sidebar-tabsmin') ;
	 jQuery('.main-container').hasClass("main-containermax") ? jQuery('.main-container').removeClass('main-containermax') : jQuery('.main-container').addClass('main-containermax');
	...
	else
	{
		...
		jQuery('.sidebar-tabs').removeClass('sidebar-tabsmin')
		jQuery('.main-container').removeClass('main-containermax') 
	}
	...
	jQuery('.sidebar-tabs').hasClass("sidebar-tabsmin") ? jQuery(tabContentSelector).removeClass('active'):jQuery(tabContentSelector).addClass('active');
